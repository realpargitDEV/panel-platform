...
mod tests {
    ...
    fn a_well_formed_release_validates() {
        let release = manifest(
            "https://github.com/realpargitDEV/project-host/releases/download/v1.2.0/app.msi",
        )
    ...
    fn a_real_manifest_document_deserialises() {
        let json = r#"{
            ...
            "platforms": {
                "windows-x86_64": {
                    "url": "https://github.com/realpargitDEV/project-host/releases/download/v1.3.0/ProjectHost_1.3.0_x64.msi",
